...
const HotStreakBettors = ({ navigation }: any) => {
  const Tabs = [
    "All",
    "NFL",
    "NBA",
    ...
    <ScreenLayout style={styles.main}>
      ...
      <View style={styles.content}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <User img={item.pic} info={item.info} name={item.name} isHot />
          )}
        />
      </View>
    </ScreenLayout>
...
export default HotStreakBettors;
